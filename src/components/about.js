  ...
  return (
	<div className="about-page">
	 ...
	 <div className="p-link">
		...
		<p><a title="Github" href="https://github.com/codejesse/">GIT</a></p>
		<p><a title="Download resume" href="https://twitter.com/jessebeke">RSM</a></p>
	 </div>
     <Link to="/works"><button className="nav-btn">WORKS &rarr;</button></Link>
	</div>
  );
}
